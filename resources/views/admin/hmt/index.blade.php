...
<div class="bg-white p-6 rounded-xl shadow-md">
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="text-gray-700">
        ...
        <tr class="border-t hover:bg-orange-50">
          ...
          <td class="py-3 px-4">Contoh pertanyaan ke-{{ $i }}</td>
          <td class="py-3 px-4">
            <img src="https://via.placeholder.com/100" alt="Soal" class="h-12 rounded border object-cover">
          </td>
  ...
  <div class="space-y-4 sm:hidden">
    ...
    <div class="border rounded-lg p-4 shadow hover:bg-orange-50">
      ...
      <p class="text-gray-700 mb-3">Contoh pertanyaan ke-{{ $i }}</p>
      <img src="https://via.placeholder.com/100" alt="Soal" class="h-20 rounded border object-cover">
    </div>
    @endforeach
  </div>
</div>
