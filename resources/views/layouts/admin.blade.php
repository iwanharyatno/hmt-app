    ...
    <div x-data="{ open: false }" class="flex h-screen" x-cloak>
        ...
        <aside :class="open ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="space-y-2 p-4">
                ...
                <a href="{{ route('admin.learning-style.history') }}"
                    class="block px-3 py-2 rounded hover:bg-orange-500">
                ...
                <a href="{{ route('logout') }}" class="block px-3 py-2 rounded hover:bg-orange-500">
